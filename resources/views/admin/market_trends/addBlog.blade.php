                        ...
                        <form id="quickForm" action="{{ route('storeBlog') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Title <span style="font-size: 11px;"><i>(title of the blog)*</i></span></label>
                                ...
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Image  <span style="font-size: 11px;"><i>(image of this blog)*</i></span></label>
