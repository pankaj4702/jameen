                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add Porperty Insight </h3>
                        </div>
                        @if (count($errors) > 0)
                        ...
                        @endif
                        <form id="quickForm" action="{{ route('storeInsight') }}" method="POST" enctype="multipart/form-data"
                            onsubmit="return validateForm()">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Title <span style="font-size: 11px;"><i>(title of the Insight)*</i></span></label>
                                ...
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Image  <span style="font-size: 11px;"><i>(image of this Insight)*</i></span></label>
