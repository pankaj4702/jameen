...
@section('content_front')
        ...
        <section class="asset-banner-comman news-main-banner">
            <div class="container">
                <div class="asset-banner-innner">
                    <h3>Market Trends</h3>
                    <h2>Jameen online News</h2>
                </div>
            </div>
        </section>
        ...
        <section class="news-main-inner">
            <div class="container">
                <div class="news-main-wapper">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="news-main-wapper-left" id="main_news_div">
                            @if($news)
                             @foreach($news as $key=>$single_news)
                             <div class="news-main-left">
                                <a href="{{ route('SingleNews',['id'=>encrypt($single_news->id)]) }}">
                                <div class="row">
                                    <div class="col-sm-6 col-md-4">
                                        <div class="news-main-imgage">
                                            <figure>
                                                <img src="{{ asset('storage/' . $single_news->image) }}" />
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-8">
                                        <div class="news-main-contant">
                                            ...
                                            @php
                                            $text = $single_news->description;
                                            $result = substr($text, 0, 120);
                                            $dateString = $single_news->date;
                            ...
                            <div class="news-main-wapper-right">
                                    ...
                                    <div class="main-news-search-inner">
                                        <form>
                                            ...
                                            <div class="main-news-search-box">
                                                <input type="text" name="search" placeholder="Search by title or description" id="news" oninput = "showNews()" />
                                ...
                                <div class="main-news-post">
                                    ...
                                    <ul class="main-news-post-content">
                                        ...
                                        @foreach($news as $key=>$single_news)
                                        <li>
                                            <a href="{{ route('SingleNews',['id'=>encrypt($single_news->id)]) }}" style="text-decoration: none;color: inherit; ">
                                            {{ $single_news->title }}
                                            </a>
