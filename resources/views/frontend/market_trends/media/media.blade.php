        ...
        <section class="news-main-inner">
            <div class="container">
                <div class="news-main-wapper">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="news-main-wapper-left" id="main_media_div">
                                @if($media)
                                @foreach($media as $key=>$single_media)
                                <div class="news-main-left">
                                  <a href="{{ route('SingleMedia',['id'=>encrypt($single_media->id)]) }}">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4">
                                            <div class="news-main-imgage">
                                                <figure>
                                                    <img src="{{ asset('storage/' . $single_media->image) }}" />
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-8">
                                            <div class="news-main-contant">
                                                <h2>{{ $single_media->title }}</h2>
                                                @php
                                                $text = $single_media->description;
                                                $result = substr($text, 0, 120);
                                                $dateString = $single_media->date;
                            ...
                            <div class="news-main-wapper-right">
                                ...
                                <div class="main-news-post">
                                    ...
                                    <ul class="main-news-post-content">
                                       ...
                                       @foreach($media as $key=>$single_media)
                                        <li>
                                            <a href="{{ route('SingleMedia',['id'=>encrypt($single_media->id)]) }}" style="text-decoration: none;color: inherit; ">
                                                {{ $single_media->title }}
                                                </a>
