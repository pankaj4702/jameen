        ...
        <section class="news-main-inner">
            <div class="container">
                <div class="news-main-wapper">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="news-main-wapper-left" id="main_blog_div">
                                @if($blogs)
                            ...
                            <div class="news-main-wapper-right">
                                    ...
                                    <div class="main-news-search-inner">
                                        <form>
                                            ...
                                            <div class="main-news-search-box">
                                                <input type="text" name="search" placeholder="Search by title or description" id="insight" oninput = "showBlogs()" />
                                ...
                                <div class="main-news-post">
                                    ...
                                    <ul class="main-news-post-content">
                                      ...
                                      @foreach($blogs as $key=>$blog)
                                        <li>
                                            <a href="{{ route('singleBlog',['id'=>encrypt($blog->id)]) }}" style="text-decoration: none;color: inherit; ">
                                                {{ $blog->title }}
                                                </a>
